...
//File includes all language related variables you can change them to any language you want. Please do not change variable names.
	...
	//Login page settings
	"login_title" => "Meanwood Property Plot Owner Portal Login!",
	...
	"email" => "Email",
	"password" => "Password",
	"registration_page_title" => "Register Now...",
	...
	"total_users" => "Total Plot Owners",
	"active_users" => "Active Plot Owners",
	"deactivate_users" => "Deactive Plot Owner",
	"ban_users" => "Ban Plot Owner",
	"suspend_users" => "Suspend Plot Owner",
	"dashboard_des_2" => "You can manage users by going to users management",
	"manage_users" => "Manage Plot Owners",
	"name" => "Name",
	...
	"description" => "Plot Number and Physical Address",
	...
	"sub_page_des_1" => "Use your account to get the latest updates, news, announcements from Meanwood Property.  You may also use our messaging system to stay in touch with us",
	...
	'label_result' => 'Field Result',
	'update_labels' => 'Update Labels',
	'label_page_title' => 'Manage Website Labels',
	'updated_label' => 'Label Updated Successfuly!',
	'settings' => 'Settings',
	'incorrect_logins' => 'Your User name or password is incorrect!',
	'update_language' => 'Update Language',
	'add_label' => 'Add Label',
	'label_add_success' => 'Label Added Successfuly!',
	'label_cannot_add' => 'Duplicate Label Field name cannot add.',
);