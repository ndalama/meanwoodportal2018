...
if(isset($_POST['sent']) && $_POST['sent'] == '1') {
	...
	try {
		...
		if($error == false) {
			...
			// Create new tables
			$create_tables = array(
				"CREATE TABLE `tickerr_users`(`id` INT NOT NULL AUTO_INCREMENT, PRIMARY KEY(`id`), `username` VARCHAR(100) NOT NULL, `name` VARCHAR(150) NOT NULL, `email` VARCHAR(40) NOT NULL, `profile_img1x` VARCHAR(400) NOT NULL, `profile_img2x` VARCHAR(400) NOT NULL, `profile_img3x` VARCHAR(400) NOT NULL, `date` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00', `password` CHAR(32) NOT NULL, `role` INT(1) NOT NULL, `ticket_departments` VARCHAR(300) NOT NULL, `bug_departments` VARCHAR(300) NOT NULL, `email_on_tactivity` INT(1) NOT NULL DEFAULT 1, `email_on_bactivity` INT(1) NOT NULL DEFAULT 1, `email_confirmation` INT(1) NOT NULL DEFAULT 2, `confirmation_str` VARCHAR(25) NOT NULL, `recover_password_str` VARCHAR(35) NOT NULL)",
				"CREATE TABLE `tickerr_ticket_departments`(`id` INT NOT NULL AUTO_INCREMENT, PRIMARY KEY(`id`), `name` VARCHAR(200) NOT NULL, `agents` INT NOT NULL, `tickets` INT NOT NULL, `date` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00', `default` INT(1) NOT NULL DEFAULT 2)",
				"CREATE TABLE `tickerr_bug_departments`(`id` INT NOT NULL AUTO_INCREMENT, PRIMARY KEY(`id`), `name` VARCHAR(200) NOT NULL, `agents` INT NOT NULL, `reports` INT NOT NULL, `date` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00', `default` INT(1) NOT NULL DEFAULT 2)",
				"CREATE TABLE `tickerr_tickets`(`id` INT NOT NULL AUTO_INCREMENT, PRIMARY KEY(`id`), `department` INT NOT NULL, `userid` INT NOT NULL, `guest_name` VARCHAR(150) NOT NULL, `guest_email` VARCHAR(40) NOT NULL, `agentid` INT NOT NULL, `access` VARCHAR(10) NOT NULL, `status` INT(1) NOT NULL, `priority` INT(1) NOT NULL, `date` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00', `last_update` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00', `subject` TEXT NOT NULL, `content` TEXT NOT NULL, `files` TEXT NOT NULL, `transferred_from` INT NOT NULL, `rating` DECIMAL(2,1) NOT NULL, `rating_msg` TEXT NOT NULL)",
				...
				"CREATE TABLE `tickerr_bugs`(`id` INT NOT NULL AUTO_INCREMENT, PRIMARY KEY(`id`), `department` INT NOT NULL, `userid` INT NOT NULL, `guest_name` VARCHAR(150) NOT NULL, `guest_email` VARCHAR(40) NOT NULL, `agentid` INT NOT NULL, `access` VARCHAR(10) NOT NULL, `status` INT(1) NOT NULL, `priority` INT(1) NOT NULL, `date` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00', `last_update` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00', `subject` TEXT NOT NULL, `content` TEXT NOT NULL, `files` TEXT NOT NULL, `transferred_from` INT NOT NULL, `agent_msg` TEXT NOT NULL)",
